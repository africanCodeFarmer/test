...
<form class="layui-form" action="" style="padding:15px;">
	...
	<div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	    	<input type="text" name="subTitle" value="${pojo.subTitle}" class="layui-input" lay-verify="">
	    </div>
	</div>
	...
	<div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	    	<input type="text" name="orignalPrice" value="${pojo.orignalPrice}" class="layui-input" lay-verify="">
	    </div>
	</div>
	...
	<div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	    	<input type="text" name="promotePrice" value="${pojo.promotePrice}" class="layui-input" lay-verify="">
	    </div>
	</div>
	...
	<div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	    	<input type="text" name="stock" value="${pojo.stock}" class="layui-input" lay-verify="">
	    </div>
	</div>
	...
	<div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	    	...
	    	<option value="${pojo.productCategory.id}">${pojo.productCategory.name}</option>
