...
<script type="text/html" id="productCategoryPropertyTp">
    <div>
		<a href="manageProductCategoryProperty?pcid={{d.id}}" class="layui-table-link">
	  ...
	  switch(obj.event){
	    case 'add':
	      ...
	      layer.open({
	            ...
	            maxmin: true,
	            area: ['60%', '60%'],
	            content: "productCategory/add.jsp",
	      });
	    break;
	    case 'delete':
    ...
    if(obj.event === 'del'){
      layer.confirm('真的删除行么', function(index){
    	...
    	layer.open({
            ...
            maxmin: true,
            area: ['60%', '60%'],
            content: "editProductCategory?id="+id,
        });
    }
  });
});
